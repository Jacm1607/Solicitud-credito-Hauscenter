...
<head>
<meta charset="UTF-8">
<title>Buro de información crediticia</title>
...
<body>
  ...
  <div style="padding: 20px; border:solid #113e66; border-radius:10px; color: #113e66">
    <table width="100%">
        <tr>
            <td width="33%"><img src="https://cdn.hauscenter.com.bo/logo/logo-hauscenter.jpg" style="width: 130px"/></td>
            <td width="33%" align="center">
                <span style="font-size: 24px; font-weight:800">AUTORIZACIÓN</span>
            </td>
      ...
      <table width="100%">
        <tr>
            <td width="30%"></td>
            <td style="border-top: solid #113e66;" width="40%" align="left">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOMBRE: <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CI:
            </td>
            <td width="30%">
